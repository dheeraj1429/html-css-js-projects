                  ...
                  if (_transformProps[property] && property !== 'transform') {
                     ...
                     if (!value || value === 'auto' || uncache || ~(value + '').indexOf('calc(')) {
                        value =
                           ...
                           Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__['_getProperty'])(target, property) ||
               ...
               _specialProps = {
                  clearProps: function clearProps(plugin, target, property, endValue, tween) {
                     if (tween.data !== 'isFromStart') {
                        var pt = (plugin._pt = new _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__['PropTween'](
                           plugin._pt,
                           target,
                           property,
                           0,
    ...
    */
               ...
               _renderCSSTransforms = function _renderCSSTransforms(ratio, cache) {
                  ...
                  if (use3D || x !== _zeroPx || y !== _zeroPx || z !== _zeroPx) {
                     transforms +=
                        z !== _zeroPx || use3D ? 'translate3d(' + x + ', ' + y + ', ' + z + ') ' : 'translate(' + x + ', ' + y + _endParenthesis;
                  }
               ...
               _addRotationalPropTween = function _addRotationalPropTween(plugin, target, property, startNum, endValue, relative) {
                  ...
                  plugin._pt = pt = new _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__['PropTween'](
                     plugin._pt,
                     target,
                     property,
                     startNum,
               ...
               _addRawTransformPTs = function _addRawTransformPTs(plugin, transforms, target) {
                  ...
                  for (p in _transformProps) {
                     ...
                     if (startValue !== endValue && exclude.indexOf(p) < 0) {
                        ...
                        endNum = parseFloat(endValue);
                        plugin._pt = new _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__['PropTween'](
                           plugin._pt,
                           endCache,
                           p,
                           startNum,
            ...
            var CSSPlugin = {
               ...
               init: function init(target, vars, tween, index, targets) {
                  ...
                  for (p in vars) {
                     ...
                     if (
                        ...
                        Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__['_checkPlugin'])(p, vars, tween, index, target, targets)
                     ) {
                        // plugins
                        continue;
                     }
                     ...
                     if (specialProp) {
                        ...
                        if (startAt && p in startAt) {
                           ...
                           p in _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__['_config'].units &&
                              !Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__['getUnit'])(startValue) &&
                              (startValue += _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__['_config'].units[p]); // for cases when someone passes in a unitless value like {x: 100}; if we try setting translate(100, 0px) it won't work.
                        ...
                        if (isTransformRelated) {
                           if (!transformPropTween) {
                              ...
                              transformPropTween = this._pt = new _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__['PropTween'](
                                 this._pt,
                                 style,
                                 _transformProp,
                                 0,
                           ...
                           if (p === 'scale') {
                              this._pt = new _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__['PropTween'](
                                 this._pt,
                                 cache,
                                 'scaleY',
                                 cache.scaleY,
                        ...
                        if (
                           ...
                           endUnit =
                              Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__['getUnit'])(endValue) ||
                              (p in _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__['_config'].units
                                 ? _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__['_config'].units[p]
                                 : startUnit);
               ...
               getSetter: function getSetter(target, property, plugin) {
                  ...
                  return property in _transformProps && property !== _transformOriginProp && (target._gsap.x || _get(target, 'x'))
                     ...
                     : target.style && !Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__['_isUndefined'])(target.style[property])
                     ? _setterCSSStyle
                     : ~property.indexOf('-')
                     ? _setterCSSProp
                     : Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__['_getSetter'])(target, property);
               },
               core: {
            ...
            (function (positionAndScale, rotation, others, aliases) {
               var all = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__['_forEachName'])(
  ...
  */
                     ...
                     ratio =
                        ...
                        (!totalTime &&
                           ((!tween._start && _parentPlayheadIsBeforeStart(tween)) ||
                              ((tween._ts < 0 || tween._dp._ts < 0) && tween.data !== 'isFromStart' && tween.data !== 'isStart')))
                           ? 0
                           : 1,
                     ...
                     function () {
                        return _isArray(min)
                           ...
                           : (roundingIncrement = roundingIncrement || 1e-5) &&
                                ...
                                Math.floor(
                                   Math.round(
                                      (min - roundingIncrement / 2 + Math.random() * (max - min + roundingIncrement * 0.99)) / roundingIncrement
                                   ) *
                                      roundingIncrement *
                                      returnFunction
                                ) / returnFunction;
               ...
               _configEaseFromString = function _configEaseFromString(name) {
                  ...
                  return ease && split.length > 1 && ease.config
                     ? ease.config.apply(
                          null,
                          ~name.indexOf('{') ? [_parseObjectInString(split[1])] : _valueInParentheses(name).split(',').map(_numericIfPossible)
                       )
            ...
            var Animation = /*#__PURE__*/ (function () {
               ...
               _proto.time = function time(value, suppressEvents) {
                  return arguments.length
                     ? this.totalTime(
                          Math.min(this.totalDuration(), value + _elapsedCycleDuration(this)) % this._dur || (value ? this._dur : 0),
                          suppressEvents
                       )
            ...
            var Tween = /*#__PURE__*/ (function (_Animation2) {
                  ...
                  if (keyframes || stagger || _isFuncOrString(duration) || _isFuncOrString(delay)) {
                     ...
                     if (keyframes) {
                        ...
                        for (i = 0; i < l; i++) {
                           ...
                           copy.delay =
                              (+_parseFuncOrString(delay, _assertThisInitialized(_this3), i, curTarget, parsedTargets) || 0) - _this3._delay;
               ...
               _proto3.render = function render(totalTime, suppressEvents, force) {
                  ...
                  if (!dur) {
                     ...
                     (timeline &&
                        timeline.render(totalTime < 0 ? totalTime : !time && isYoyo ? -_tinyNum : timeline._dur * ratio, suppressEvents, force)) ||
               ...
               _proto3.kill = function kill(targets, vars) {
                  ...
                  if (this.timeline) {
                     ...
                     this.timeline.killTweensOf(targets, vars, _overwritingTween && _overwritingTween.vars.overwrite !== true)._first ||
                        _interrupt(this); // if nothing is left tweening, interrupt.
            ...
            var _gsap = {
               ...
               registerEffect: function registerEffect(_ref2) {
                  ...
                  (plugins || '').split(',').forEach(function (pluginName) {
                     return (
                        pluginName && !_plugins[pluginName] && !_globals[pluginName] && _warn(name + ' effect requires ' + pluginName + ' plugin.')
                     );
                  });
               ...
               _createClass(Magnetic, [
                  ...
                  },
                  {
                     ...
                     value: function move(x, y, speed) {
                        gsap__WEBPACK_IMPORTED_MODULE_1__['default'].to(this.el, { y: y, x: x, force3D: true, overwrite: true, duration: speed });
                     },
                  },
               ]);
               return Magnetic;
