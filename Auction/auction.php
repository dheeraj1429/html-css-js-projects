...
$subject =  ' subscribe auction';
$msg ="<h1>thanks for subscribe auction</h1>";
        ...
        <div class="row g-3">
          ...
          <div class="col-12 col-sm-12 col-md-12 col-lg-6  ">
            ...
            <div class="mt-2 col-12 col-sm-12 ">
              <div class="d-flex col-6 col-sm-12 col-md-6 col-lg-12 justify-content-evenly">
            ...
            ?>
              ...
              <a target="_blank" href="login.php?redirect=<?php echo $_SERVER['REQUEST_URI'] ?>" class="btn btn-lg rounded-pill h4 fw-bolder btn-danger buy_Button mb-5 login-btn">Please Login
                to Enter Auction</a>
            <?php } ?>
          </div>
        </div>
