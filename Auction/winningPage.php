...
if(isset($_GET['auction'])){
 ...
 $winner = mysqli_fetch_assoc($winnerSql);
  $bidSql = mysqli_query($conn,"SELECT bb.email,bb.amount, us.name,us.img FROM `".$tblPrefix."bid` bb LEFT JOIN `".$tblPrefix."users` us ON bb.email = us.email WHERE bb.auction_id = $id");
}else{
    ...
    <section class="winner_section side_padding">
      <div class="container-fluid padding_one">
        ...
        <div class="row pt-5 pb-3 justify-content-center">
          ...
          <div class="col-12 col-sm-12 col-md-12  <?php if(isset($_GET['auction'])){ echo "col-lg-7 col-xxl-9";}else{echo "col-lg-12 col-xxl-12";}?>">
            <!-- all auction winner -->
            <div class="row">
              <div class="col-12">
                <div class="auctionList_div_content">
                  <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 d-flex align-items-center justify-content-center justify-content-md-center">
                    ...
                    <div class="row user_sub_cards mt-3">
                      <div class="col-12 col-sm-12 col-md-6  d-flex align-items-center justify-content-center justify-content-md-start mb-3 mb-md-0">
                        <div class="user_sub_img ">
                          <img src="./assets/img/user/<?php echo $res['img']?>" alt="" class="img-fluid">
                        </div>
